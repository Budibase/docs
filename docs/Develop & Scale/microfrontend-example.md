...
For bridge mode, set Budibase platform URL to the BFF public URL (for local: `http://localhost:5174`). This prevents Budibase OIDC redirects from sending users to `:10000`.
