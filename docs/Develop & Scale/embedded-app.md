...
<Image align="center" alt="Click the 'Copy code' to quick copy the iframe contents" border={false} caption="Click the 'Copy code' button to quick copy the iframe contents" src="https://files.readme.io/6ea4755-copy_code.png" />
