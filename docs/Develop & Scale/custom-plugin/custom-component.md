...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d9a3c89-Screenshot_2022-09-28_at_13.49.58.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/116950f-configure_validation.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/75a8f47-Screenshot_2023-01-26_at_15.39.14.png",
        null,
        "Selecting the component that triggered the event"
      ],
      "align": "center",
      "caption": "Selecting the component that triggered the event"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2bd4598-Screenshot_2023-01-26_at_15.39.23.png",
        null,
        "Selecting the On Change event detail "
      ],
      "align": "center",
      "caption": "Selecting the On Change event detail "
    }
  ]
}
[/block]