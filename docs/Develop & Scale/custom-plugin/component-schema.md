...
[block:parameters]
{
  "data": {
    ...
    "0-0": "type\\*",
    "0-1": "string",
    "0-2": "The type of the setting.  \n  \n_A full list of setting types can be found in the [componentMap](https://github.com/Budibase/budibase/blob/master/packages/builder/src/components/design/settings/componentSettings.js)_",
    "1-0": "key\\*",
    "1-1": "string",
