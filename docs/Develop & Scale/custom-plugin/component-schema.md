  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        *A full list of setting types can be found in the[componentMap](https://github.com/Budibase/budibase/blob/master/packages/builder/src/components/design/settings/componentSettings.js)*
      </td>
    </tr>
