...
In the below example, a single Data Provider can supply information to the Sales Bar Chart, as well as a Repeater that displays a Container with a Text component _for every row the data provider returns_.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a9f7d6f55f32a684ca3483aabfbe61b11dd960a092b5536372da893ba11b5b69-Screenshot_2025-08-14_at_10.38.06.png",
        null,
        ""
      ],
      "align": "center"
