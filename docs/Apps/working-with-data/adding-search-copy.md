...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2da5e191e08a716692bc9282326de2bc92395cb43612336cc4a78c29eb8df65a-Screenshot_2025-08-18_at_11.28.37.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8984325215d880b215e016647d0eb30d4e3c284f68b0aa52fb20e5d9b7afaa96-Screenshot_2025-08-18_at_11.32.26.png",
        null,
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a47ec2f19274fb6c2f26b4cf3a8fc54544bd433940e69f5068936259c1f701e0-Screenshot_2025-08-18_at_11.31.40.png",
        null,
        ""
      ],
      "align": "center"
...
With these settings, when no nothing in in the search bar, all rows will be displayed. When something is in the search bar, all rows where the region is _like_ (ie a partial or full match) will be returned. When Country or Item Type are an exact match, rows will be returned accordingly.  When there are no rows that match, the table will show all rows available.
  ...
  "images": [
    {
      ...
      "align": "center",
      "caption": "An example using Customer Name to search the data."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7e186d27212492df108b0180a31e60c6970418461069874365add00dad529ca3-Screenshot_2025-08-18_at_12.01.22.png",
        null,
        null
      ],
      "align": "center"
...
3. [block:image]{"images":[{"image":["https://files.readme.io/4ebacec14d0e470f3131961ebb55b0a6cdfb59c544c597fa1ac24a3b5347f33d-Screenshot_2025-08-18_at_12.02.00.png",null,null],"align":"center"}]}[/block]
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/3214d6281e823bf968bf144de4aa0b5765b5c806333a9d6f39d3d87be39568c2-Screenshot_2025-08-18_at_12.12.15.png",null,null],"align":"center"}]}[/block]
4. In the settings of the Dynamic Filter you can now give users the option to set filters based on allowed columns. 

   [block:image]{"images":[{"image":["https://files.readme.io/b619915dc4ab133cd1b7c1bc749fca17529e63857414b49d394a8734d8d8e837-Screenshot_2025-08-18_at_12.13.55.png",null,null],"align":"center"}]}[/block]
