...
metadata:
  robots: index
---
A gauge chart displays progress or performance for multiple items simultaneously using coloured circular arcs. Each ring represents a separate entity (e.g., a user, task, or metric), and the length of the colored arc shows how much of the target has been achieved
...
Now if we hover over any of the rings they will display a percentage, for example, if we over over Fiona, we can see she has used 43.33% of her total annual leave
