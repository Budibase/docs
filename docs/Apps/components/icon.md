...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/084579369256a577b089ba99b11a4cff8acd794c8b40731bb1b896034ca7afae-Screenshot_2025-08-21_at_11.42.08.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ed10922d2bf0d1776342c9571494cd9e0522c8a1974866fbb493e95d71e01d3a-Screenshot_2025-08-21_at_11.38.51.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/99ec32665a406c9b4b2f438c7e20539da4d857aee2348649b1505b9507da5636-Screenshot_2025-08-21_at_11.42.46.png",
        null,
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/62aa1913fd00d216b657911f00a532ca4b8ccbc23dc6891ee046ae713e24bdf2-Screenshot_2025-08-21_at_11.43.23.png",
        null,
...
3. Nest an Icon component within the repeater. This will display an icon for each tag.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/aea4cc0bcaaacabc881a2bc15c06bf1829a04af78d5b9f7860357576e7d4178e-Screenshot_2025-08-21_at_11.45.22.png","",""],"align":"center"}]}[/block]
...
7. Click the `Add condition` button to create your conditions. In our case, we are going to use the update setting option. This will allow us to dynamically change the icon based on the inventory table's tag values. (Use the duplicate button to make your life easier!)
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/3d0891de053e4da016fe2a529de8030aab1012502e9cf8fe8a20f6f69002c8f9-Screenshot_2025-08-21_at_11.49.49.png","",""],"align":"center"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e1d65921b4fe8c89cad130ac1a021853e777ef9123ea51b0811ab4e20f901fc0-Screenshot_2025-08-21_at_11.50.13.png",
        "",
        ""
      ],
      "align": "center"
