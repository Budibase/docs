...
Unlike other <<glossary:Binding>> values, App state values can be set and used anywhere in your application. To set an app state value, you can use an action called `Update state` in the actions drawer. There are two types: Setting and Deleting. Set a key as the unique identifier; this is used when referencing the state value elsewhere in your app. You can select an already existing one or create one by typing in a name. After this, you can enter any value into the value input field. In addition to static values, you can also use <<glossary:Binding>> values here.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4a8c1719305159c380db29ad8cfa8bcc77964b19f93d028cf9dc619dfe3cea5c-Screenshot_2025-08-20_at_11.05.42.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c4f14d915f80a3662820935457da6242ff2db81d3a3c742b9d2fa277c71fdc41-20250820_110920.gif",
        null,
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/def9f441edb0e38232b11ba7490e05b1846eb9288e360ade863311f14007599f-20250820_112223.gif",
        null,
        ""
      ],
      "align": "center"
