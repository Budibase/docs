...
2. Add a table nested inside the Data Provider, with the data source as the Data Provider (not fetching data directly) 
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/9e4d94eae7e87dfbbc3d7cdeda8b05cfd22fc450d3e2c734d77a3e12c52c7319-Screenshot_2025-08-15_at_14.51.20.png","",""],"align":"center"}]}[/block]
...
4. Add a text field to the form, setting the field to "email" and the label to "Search Employee Email" 
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/b4d288121bec9660b4262f73ba4682d84e0774ba36126fc2ecd3be8675f7e0d4-Screenshot_2025-08-15_at_14.53.05.png","",""],"align":"center","sizing":"450px"}]}[/block]
...
6. Add the filter `Email` is `Like` the `Binding` `{{ New Form.Fields.email }}` 
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/a60d3d4c46670eefa7f3bd997408ec52911cfef4db49b2f742489ffbac907349-Screenshot_2025-08-15_at_14.53.31.png","",""],"align":"center"}]}[/block]
7. Add a button underneath the Data Provider, with the button text to "Add new employee"
8. Add a <<glossary:Settings Panel>> with "Ignore clicks outside" checked, and the size set to "Medium.
9. Add a Form Block to the modal, set to create a new row in the Employees Table. 

   [block:image]{"images":[{"image":["https://files.readme.io/8818d059b53875cbfeeda81a4f926c46c65bdaef665d21e09cb778a7e07c6068-Screenshot_2025-08-15_at_14.55.20.png","",""],"align":"center","sizing":"450px"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/76f2132b269d4f2a346ec243c42f947bb143efb3258a0ad756052b0c55eb0696-Screenshot_2025-08-15_at_15.00.42.png",
        "",
        ""
      ],
      "align": "center"
