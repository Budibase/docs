...
<HTMLBlock>{`
<iframe width="800" height="480" style="border: thick double #32a1ce; max-width: 100%;" allow="clipboard-write;camera;geolocation;fullscreen" src="https://plugins.budibase.app/embed/update-date-field-on-change"></iframe>
`}</HTMLBlock>
...
*Downloads may take a few seconds to begin*
