...
excerpt: >-
  To help you adopt Budibase quicker and uncover what's possible, we've
  dedicated this section of the documentation to guides, examples, templates,
  and more.
deprecated: false
hidden: false
metadata:
...
| How to build a simple CRUD app using Budibase DB                                 | [Docs](doc:build-a-crud-app)                                                                     |
| How to build a simple CRUD app using PostgreSQL                                  | [Docs](doc:build-a-crud-app-sql)                                                                 |
| Build a LOW CODE Internal App in 15 Minutes with Users, Auth, Discord, and MORE! | [Video](https://www.youtube.com/watch?v=BZZT1JmRM1A)                                             |
...
| Filtering on selected rows                                                       | [Github answer](https://github.com/Budibase/budibase/discussions/8759#discussioncomment-4207094) |
...
[block:embed]
{
  ...
  "href": "https://www.youtube.com/watch?v=BZZT1JmRM1A"
}
[/block]
