...
title: Overview
excerpt: >-
  Budibase is an open-source low-code platform that helps you build internal
  tools in minutes
deprecated: false
hidden: false
metadata:
...
![](https://files.readme.io/bf7ddb1-pika-2022-08-10T10_17_04.558Z.png)
...
After [Installing](doc:hosting-methods) Budibase, we advise users to either begin with a [Quickstart tutorial](doc:quickstart-tutorials) or use a [Budibase template](https://budibase.com/templates/).