...
<Image align="center" src="https://files.readme.io/57eed32-CleanShot_2024-01-10_at_09.07.142x.png" />
...
After [Installing](doc:hosting-methods) Budibase, we advise users to either begin with a [Quickstart tutorial](doc:quickstart) or use a [Budibase template](https://budibase.com/templates/).
