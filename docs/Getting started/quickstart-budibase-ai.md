...
1. Go to your **Settings** area and click the AI tab.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/e7235f4578fbbaca09f344ab69d0de1b1e8e04b336a95a2da93b9f7b14c893cc-Screenshot_2025-08-15_at_13.43.02.png","",""],"align":"center"}]}[/block]
...
1. Go to your **Settings** area and click the AI tab.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/3424edac526e8047970c65e7022a29c635c3ac7c9fdd0d942c72c22159b2b380-Screenshot_2025-08-15_at_13.44.14.png","",""],"align":"center"}]}[/block]
...
3. Choose which AI provider you wish to use.
   ...
   1. Budibase AI
      ...
      2. if you haven't activated your license key whenever you try to enable you will be prompted with a modal saying you must add a license key.
         ...
         [block:image]{"images":[{"image":["https://files.readme.io/192a0e79d0db94d8391012877901c83ea911268d696bcfcc36727a8cac26305e-Screenshot_2025-08-15_at_13.44.37.png","",""],"align":"center"}]}[/block]
   2. OpenAI

      1. Click the setup button
      2. This opens a modal where you’ll need to fill in the required fields

         [block:image]{"images":[{"image":["https://files.readme.io/0a76fb8007e2d32114981928b4c1c8e9b5aa69d30ce73d587c01afd1d733b666-Screenshot_2025-08-15_at_13.45.10.png","",""],"align":"center"}]}[/block]
   ...
   3. Azure OpenAI
      ...
      2. This opens a modal where you’ll need to fill in the required fields
         ...
         [block:image]{"images":[{"image":["https://files.readme.io/2e3b76f508c755532f740ffedbf5af6d49c500a1b15e232c5981b55b24c5aca8-Screenshot_2025-08-15_at_13.45.43.png","",""],"align":"center"}]}[/block]
...
- [AI Automation Actions](https://docs.budibase.com/v3.3.0/docs/ai-automation-steps-overview)  
...
- [Generate Tables in Budibase DB](https://docs.budibase.com/v3.3.0/docs/ai-powered-table-generation)  
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/af9f3e6ec2575c28bc6b5a7c98e34e2eda35026396dea6a2e586ba8e41a8be69-Screenshot_2025-08-15_at_13.55.52.png",
        null,
        null
      ],
      "align": "center",
      "caption": "AI Automation Actions in Budibase"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e4e8cb20a610aeee264cd951c47bddf4bb75db4d28924bb1bfc26280cbebb40b-Screenshot_2025-08-15_at_13.50.36.png",
        null,
        "Generate table schemas for your Workspace with Budibase AI"
      ],
      "align": "center",
      "caption": "Generate table schemas for your Workspace with Budibase AI"
    }
  ]
}
[/block]