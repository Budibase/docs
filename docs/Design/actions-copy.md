...
next:
  description: ''
---
There are a wide variety event actions throughout Budibase. These can be split into four different types [Data actions](doc:data-actions), [Application actions](doc:application-actions), [Form actions](doc:form-actions) and [Logic actions](doc:logic-actions).
