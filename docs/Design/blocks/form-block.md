...
After you pick a table schema, you will be able to select fields by clicking on `Configure fields`, as well as position the _Field labels_.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d33af98-Screenshot_2023-07-31_at_12.53.02.png",
        null,
        ""
      ],
      "align": "center",
