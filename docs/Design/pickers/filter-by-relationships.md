...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/31a42fd-Screenshot_2023-08-11_at_09.40.03.png",
        "",
        "Copy row \\_id"
      ],
      "align": "center",
      "caption": "Copy row \\_id"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/45244d6-Screenshot_2023-08-11_at_10.23.49.png",
        "",
        "Displaying the underlying values of the chosen relationship links"
      ],
      "align": "center",
      "caption": "Displaying the underlying values of the chosen relationship links"
    }
  ]
}
[/block]
...
As mentioned above, relationship pickers expose encoded row identifiers. Therefore, to provide a <<glossary:Default Value>> for a relationship picker, we must provide an array of row identifiers.
...
2. Select the table that matches the source of the relationship field, and untick _Paginate_
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6b32cfc-Screenshot_2023-08-11_at_10.42.09.png",
        "",
        "Adding a Data provider to be used by the 'Cities' relationship picker"
      ],
      "align": "center",
      "caption": "Adding a Data provider to be used by the 'Cities' relationship picker"
    }
  ]
}
[/block]
...
3. Click the button beside _Filtering_, and add an **Is in** filter as follows:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/69f961b-Screenshot_2023-08-11_at_10.44.33.png",
        "",
        "Fetch some default (comma separated) cities"
      ],
      "align": "center",
      "caption": "Fetch some default (comma separated) cities"
    }
  ]
}
[/block]
...
5. Click the lightning bolt icon beside the _Default value_ field of the relationship picker, and add the following JavaScript code:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/71294c3-Screenshot_2023-08-11_at_10.47.49.png",
        "",
        "Relationship picker with default values"
      ],
      "align": "center",
      "caption": "Relationship picker with default values"
    }
  ]
}
[/block]
...
You can add filters in the <<glossary:Settings Panel>> by clicking on the _Filtering_ button.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a384468-4d873bd-Screenshot_2023-08-14_at_11.51.17.png",
        "",
        ""
      ],
      "align": "center"
...
1. Click the button beside _On change_ in the <<glossary:Settings Panel>>
2. `Add action`: **Fetch Row** and select the table that matches the relationship table
3. Set the _Row ID_ to `{{ Field Value }}`
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/77a8708-Screenshot_2023-08-14_at_13.32.59.png",
        "",
        "Fetching the selected row data"
      ],
      "align": "center",
      "caption": "Fetching the selected row data"
    }
  ]
}
[/block]
...
4. `Add action`: **Show Notification** and use [Action chaining](doc:chaining-actions) to retrieve the value from the **Fetch Row** action, using the <<glossary:Binding>> `{{ Action 1.Fetched row }}` to retrieve the whole row, or reference specific columns such as the country name.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cd4adf7-Screenshot_2023-08-14_at_13.35.13.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5b28ad6-Screenshot_2023-08-14_at_13.36.52.png",
        "",
        ""
      ],
      "align": "center"
