...
<Image alt="Adding a section" align="center" src="https://files.readme.io/471fcc8-Screenshot_2023-01-30_at_13.25.44.png">
  Adding a section
</Image>

The <Glossary>Settings Panel</Glossary> allows you to select the layout type of the section. A *Type* button will display the currently selected type, with the default set to *Main with Sidebar*.

<Image alt="Default new section" align="center" src="https://files.readme.io/913dd55-Screenshot_2023-01-30_at_13.45.43.png">
  Default new section
</Image>
...
To complete this column, nest a [Stat Card](doc:stat-card) within the repeater block, and use the name field <Glossary>Binding</Glossary>. 
...
<Image alt="Duplicating the New Container" align="center" src="https://files.readme.io/4c587f8-Screenshot_2023-01-30_at_14.18.26.png">
