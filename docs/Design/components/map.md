...
![1000](https://files.readme.io/19b09e3-map.jpg "map.jpg")
...
![872](https://files.readme.io/cdf037d-new-map.png "new-map.png")
...
![241](https://files.readme.io/d7f90b2-map-binding.png "map-binding.png")
...
![977](https://files.readme.io/ba06d73-map-goto-detail.png "map-goto-detail.png")
...
![195](https://files.readme.io/7c67c8a-enable-new-markers.png "enable-new-markers.png")
...
![199](https://files.readme.io/882886f-new-marker-on-map.png "new-marker-on-map.png")
...
![2214](https://files.readme.io/802ee54-map-tilesets.jpg "map-tilesets.jpg")
...
<Table align={["left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Shows an icon in the top-right corner allowing the user to see the map fullscreen when clicked
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Shows an icon in the bottom-right the user can click to display their own location on the map
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Allows the users to zoom in/out, either through scrolling, double-clicking or through the `+` and `-` buttons on the bottom-right.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        This is the location the map will focus on when it's empty. Accepted input is `latitude,longitude` with a `.` as decimal marker. Once markers load this will be calculated
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The zoom level the map will be in by default, before markers are loaded. This is a value between 1-100 where 100 is the most zoomed in.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The attribution displayed on the map. Usually required in terms when using a map provider.
      </td>
    </tr>
  </tbody>
</Table>
