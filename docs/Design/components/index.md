...
![](https://files.readme.io/6effff8-Screenshot_2022-07-09_at_11.43.20.png "Screenshot 2022-07-09 at 11.43.20.png")
...
![](https://files.readme.io/cc3f6b2-screen-components.png "screen-components.png")
...
![](https://files.readme.io/fd1029c-Screenshot_2022-07-09_at_12.02.25.png "Screenshot 2022-07-09 at 12.02.25.png")

You can also see the available [Blocks](doc:blocks) from the blocks tab.
...
Parent components include those related to a <Glossary>Data Source</Glossary> or some variety of container:

* [Data Provider](doc:data-provider) 
* [Repeater](doc:repeater) 
* [Table](doc:table) (elements can be added to each row)
* [Forms](doc:forms), [Form steps](doc:form-steps) and [Field groups](https://docs.budibase.com/docs/forms#field-groups)
...
![](https://files.readme.io/0fce700-Screenshot_2022-07-09_at_12.45.13.png "Screenshot 2022-07-09 at 12.45.13.png")
