...
2. Nest a [Table](doc:table) underneath. Click `Configure columns` and `Add all columns`. Remove all columns except for _Item Name_, and `Save`.
3. Nest a [Repeater block](https://docs.budibase.com/docs/blocks#repeater-block) under the table. Select _Item Tags_ as the datasource.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/37f34de-Screenshot_2023-02-07_at_12.53.04.png",
        null,
        null
      ],
      "align": "center",
      "caption": "For each table row, iterate over each tag"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e245991-Screenshot_2023-02-07_at_13.13.15.png",
        null,
        null
      ],
      "align": "center",
...
The <<glossary:Binding>> value in this instance is: `{{ Tags Repeater block.Item Tags.value }}`.

6. Set the icon _Size_ to 'Large' and change the layout of the repeater block to 'Row layout'.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0e417d0-Screenshot_2023-02-07_at_13.26.04.png",
        null,
        null
      ],
      "align": "center",
