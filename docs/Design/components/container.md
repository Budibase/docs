...
When using containers to layout your components, the most important setting is _Direction_ as this will determine the flow of components. Even the [Screen](doc:screens) can set a layout direction.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9b3652a-Screenshot_2023-07-20_at_17.46.52.png",
        null,
        "Screen column layout"
      ],
      "align": "center",
      "caption": "Screen column layout"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/00115de-Screenshot_2023-07-20_at_17.47.26.png",
        null,
        "Screen row layout"
      ],
      "align": "center",
      "caption": "Screen row layout"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c3c5f01-Screenshot_2023-07-20_at_17.52.30.png",
        null,
        "Combining row and column directions"
      ],
      "align": "center",
      "caption": "Combining row and column directions"
    }
  ]
}
[/block]
