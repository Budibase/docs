...
Furthermore, you can combine `pluck` with `sum` to count a total, such as the kilogram *weight* of the selected items: `{{ toFixed (sum (pluck New Table 1.Selected Rows 'KGS')) 2 }} KG`. 
