...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d09d42c-224bfaf-Screenshot_2023-05-19_at_11.27.45.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/15a00b5-6bfc5bc-Screenshot_2023-05-19_at_11.50.58.png",
        null,
        ""
      ],
      "align": "center"
...
This can be useful when navigating between [Form steps](doc:form-steps), as shown in this [guide](https://docs.budibase.com/docs/scroll-to-form-field).