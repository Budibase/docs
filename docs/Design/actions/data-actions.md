...
This has extremely good documentation elsewhere, you can find more on this action [here.](doc:app-state)

## Upload File To S3

Similarly to the above this also has good documentation which can be found [here.](doc:s3-file-upload#upload-file-to-s3-action)
