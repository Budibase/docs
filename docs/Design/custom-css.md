...
As Budibase uses the Spectrum design system, you can see the list of available classes here: <https://opensource.adobe.com/spectrum-css>
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/708a7ba73bcb9cc860b31668f3ed13217d90bfa66e2be26a9adf29a48b6a75d6-Screenshot_2024-09-12_at_11.50.30.png",
        "Screenshot 2022-05-12 at 10.40.30.png",
        ""
      ],
      "align": "center"
    }
