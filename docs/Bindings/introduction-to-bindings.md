...
Along the right hand side, you will see a list of bindings categories which you can search and dig into to find the binding expression you would like to add. It is worth noting that you can combine static text with binding values, which are distinguished by blue highlighted text.
