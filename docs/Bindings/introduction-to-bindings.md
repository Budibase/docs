...
next:
  description: ''
---
Bindings are a core concept in Budibase, and expand the functionality of your <<glossary:Workspace>>s beyond the standard [autogenerated screens](https://docs.budibase.com/docs/table-block#autogenerated-screen).
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cb1d2d72f3d1e510e788b54332ce44e5ac265338db8839160d06b0c8f23c0add-Screenshot_2025-08-18_at_12.54.31.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/542f2051c6e22719b64b92c38109dd20f2ba4c99e175c08473f10179de851291-Screenshot_2025-08-18_at_12.52.58.png",
        "",
        ""
      ],
      "align": "center"
...
If an arrow is present, this means that the item is a category that must be drilled into. Regarding the binding `{{ Current User.firstName }}`, we are accessing the _firstName_ text property from the _Current User_ object. 
...
Within the text area type `{{`. This will immediately prompt a dialog with a scrollable list of binding options. Start typing to filter this list; you filter by the property name or category name. Next, use the arrow keys to navigate the list, and press the _Enter_ key to insert the binding you want.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5d1d6ece0a6f4c1e69f88d18bfa96e6d9888b358885b6b173be56446437d6564-Screenshot_2025-08-18_at_12.55.59.png",
        null,
