...
| `REDIS_USERNAME` | The username used to access the Redis instance. When set alongside `REDIS_PASSWORD`, Budibase will configure a Redis ACL user with full permissions. |
