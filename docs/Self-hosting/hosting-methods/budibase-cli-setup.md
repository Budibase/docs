...
![Image](https://files.readme.io/f7e8a5c-image.png)
...
<div style={{ backgroundColor: "#018FF4", padding: "10px", borderRadius: "5px" }}>
  <span role="img" aria-label="robot">🤖</span>
  <a href="https://docs.budibase.com/v1.0.9/recipes/budibase-cli-setup-npm" style={{ color: "#FFF" }}>
...
![Image](https://files.readme.io/74b2b8f-image.png)
