...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The number of consecutive failed login attempts allowed before an account (or email address) is temporarily locked. The default is 5.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The duration in seconds for which an account is locked after exceeding failed attempts. The default is 900 (15 minutes).
      </td>
    </tr>
