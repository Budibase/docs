...
<Image align="center" border={true} width="200px" src="https://files.readme.io/19e0d6a-Screenshot_2022-09-05_at_15.43.38.png" className="border" />
...
<Image border={false} src="https://files.readme.io/c3a6d67-image.png" />
...
<Image border={false} src="https://files.readme.io/8ed9417-image.png" />

3. Look for the **Google Sheets API** card in the API Library and click it.

<Image border={false} src="https://files.readme.io/2fa0e1e-image.png" />

4. Click **Enable** and the Sheets API should be ready to use.

<Image border={false} src="https://files.readme.io/38939eb-image.png" />

### Configure Google Auth

Log in to your Budibase installation and visit the '**Auth**' section. Enter the Client ID and Client Secret generated above. The callback URL should be pre-filled based on the _Platform URL_ setting in the _Organisations_ menu.

<Image align="center" border={false} width="400px" src="https://files.readme.io/c0bc205-image.png" />
...
<Image align="center" border={true} width="300px" src="https://files.readme.io/a2311c9-image.png" className="border" />

<Image align="center" border={true} width="32px" src="https://files.readme.io/715d5ac-image.png" className="border" />
...
<Image align="center" border={true} width="260px" src="https://files.readme.io/64f830cee178415a3a780500884625b384c3367a6ec7386b8e4b65a2f1aa028a-Screenshot_2025-09-25_at_09.17.21.png" className="border" />
