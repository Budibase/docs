...
metadata:
  robots: index
---
The **Connections** area in Workspace Settings is where you configure external and AI-powered integrations used across your workspace.
...
If you previously used AI setup pages labeled **AI config** or **AI Configs**, these are now under **Connections > AI models**.
