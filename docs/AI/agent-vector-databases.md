...
In Budibase, vector databases are configured in **Workspace Settings > Connections > Knowledge bases** and then assigned from an Agent's **Operations** panel.
...
3. In the **Knowledge** area, select a **Vector database**
