...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3bfe93ea6bf624e15b337299cb5fbc79c24ba4e577d70f13eff32b31ade564b4-Screenshot_2025-04-14_at_13.50.19.png",
        "",
        "Sending a calendar invite"
      ],
      "align": "center",
      "caption": "Sending a calendar invite"
    }
  ]
}
[/block]
...
In this screenshot above, a start and end time for the meeting was manually selected, however you can also use <<glossary:Binding>> values, by clicking the lightning bolt icon.

Both the _Location_ and _URL_ properties are optional, as your meeting may be in person, or online. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/47ad50f8eac5614b4206edbba811e13ca6f80e24b01a48607b72649e92afe6ef-Screenshot_2025-04-14_at_14.00.00.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/02aca7eb0d12509472981f7d5036c27ba15f41dea3e1c4beb5d392f0e7dbae74-Screenshot_2025-04-14_at_14.17.38.png",
        null,
        ""
      ],
      "align": "center"
...
In the **Data ** section, add a new _User_ column to the _Inventory_ table called 'AssignedTo'  and click `Save`. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/09b104b757d54d7c1141b55619fe1ce7715f4dc4f81ac9b95781f4940f10f934-Screenshot_2025-04-15_at_08.52.11.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e458e01d0ad8ae660236c798973beebc1130d393fda7e881f1d105971ddaf685-Screenshot_2025-04-15_at_08.53.58.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3bb36ca44c54014cb2e0efc63acc10001b644c6c16ae4fd44ae1ac102ab2c05d-Screenshot_2025-04-15_at_08.54.16.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/107aa92d9aff7cbbc774af3cd38ae9ad01b7cbf84d153e8bf42c771cfbe27a3b-Screenshot_2025-04-15_at_08.55.34.png",
        "",
        ""
      ],
      "align": "center"
...
In the **Design** section. Add a [Table](doc:table) for the _Inventory_ table, with a [filter](https://docs.budibase.com/docs/data-provider#filtering): 'AssignedTo' _Is empty_
...
Use the setting cog to configure the buttons settings. Here you will be able to change its name and add _on click_ actions. Add a [Trigger automation](https://docs.budibase.com/docs/application-actions#trigger-automations) action, selecting the automation you created in the previous step.
...
Click `Add Column`, and set _AssignedTo_ as `{{ Current User._id }}`. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/544dac37f27fcbc18b1a5a6ef40ba0cf6b4ffd1a73a552c118c854a8dfc45d4a-Screenshot_2025-04-15_at_09.03.53.png",
        "",
        ""
      ],
      "align": "center"
