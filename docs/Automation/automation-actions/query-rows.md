...
<Image alt="Query rows action" align="center" src="https://files.readme.io/50773b638c541e7357032cebbf5d78513af698f507388599d0cd8c38bb7c41-Screenshot_2025-04-14_at_13.34.57.png">
  Query rows action
</Image>
...
<Image alt="Make sure to select a table for your Query Rows action!" align="center" src="https://files.readme.io/8eae4c59c41213203241d13072b1a717ffe32547cabf433b9c532e84b7e9bb11-Screenshot_2025-04-14_at_13.33.08.png">
...
You may provide filters when querying table rows by clicking the `Define filters` button. Filters can be against static values, or against [Bindings](doc:data-in-automations). Relationship fields are also supported for filtering, allowing you to filter rows based on their associations with other tables.
