...
In particular the [On demand](doc:app-action) trigger allows an <Glossary>End User</Glossary> to directly trigger an automation. It is also possible to call these *On demand* automations from another automation. This is done with the **Trigger an automation** step. 
...
Select an *Automation* (only **On demand** automations will be available). Next you will see the fields from the target automation that must be filled out. In this case it is just the *employee\_id*.

<Image alt="On demand trigger of the target automation" align="center" src="https://files.readme.io/92d241856f48113f829c710af4a24eb9f5975234b5056eed6109de9ec39e6ee9-Screenshot_2025-04-15_at_09.18.38.png">
  On demand trigger of the target automation
</Image>
...
1. First create a new [On demand](doc:app-action) automation, and `Add field` *employee\_id*. 
