...
> 👍 Follow along
>
> To follow along with our example, load the csv-data from the [Budibase DB Quickstart guide](doc:build-a-crud-app)

First, define a `Row Created` Trigger.

![506](https://files.readme.io/e69509f-row-created-trigger.png "row-created-trigger.png")
...
![480](https://files.readme.io/8ce33bb-trigger-data-field.png "trigger-data-field.png")

Doing the same in JavaScript binding is of course also possible.

![325](https://files.readme.io/1352bec-trigger-data-field-javascript.png "trigger-data-field-javascript.png")

And then of course we're setting our value `2015` and the `greater than` condition accordingly.

![499](https://files.readme.io/f9bb2be-condition-configuration.png "condition-configuration.png")
...
![535](https://files.readme.io/e0ba259-define-filters.png "define-filters.png")
...
![1038](https://files.readme.io/17c383c-query-rows-filter-year.png "query-rows-filter-year.png")
...
![366](https://files.readme.io/225eb36-data-results.png "data-results.png")
...
![513](https://files.readme.io/c3dc349-condition-query-result.png "condition-query-result.png")
