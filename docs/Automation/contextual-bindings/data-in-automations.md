...
[block:callout]
{
  "type": "success",
  "title": "Follow along",
  "body": "To follow along with our example, load the csv-data from the [Budibase DB Quickstart guide](doc:build-a-crud-app)"
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e69509f-row-created-trigger.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8ce33bb-trigger-data-field.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1352bec-trigger-data-field-javascript.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f9bb2be-condition-configuration.png",
...
[block:callout]
{
  "type": "success",
  "title": "Trigger.row",
  "body": "`Trigger.row` will always contain the row from the trigger, in an object format, when the action is row-related. No matter how many actions you've added in between, the data will be there to be used as an object."
}
[/block]

[block:api-header]
{
  "title": "Querying data with trigger data as filter"
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e0ba259-define-filters.png",
        "define-filters.png",
        535,
        285,
        "#1e1e1e"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/17c383c-query-rows-filter-year.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/225eb36-data-results.png",
        "data-results.png",
        366,
        292,
        "#262626"
...
[block:api-header]
{
  "title": "Using Automation Step Data"
}
[/block]
...
[block:code]
{
  "codes": [
    {
      "code": "Your {{ steps.2.rows.0.Make }} {{ steps.2.rows.0.Model }} {{steps.2.rows.0.[License Plate]}} was just automatically queried ",
      "language": "handlebars"
    }
  ]
}
...
[block:api-header]
{
  "title": "Using Query Result as a condition"
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c3dc349-condition-query-result.png",
