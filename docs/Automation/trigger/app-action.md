...
> 📘 Fire and forget
>
> Automations run asynchronously on a background thread, therefore once an automation is triggered from the client, there will be no returned response.
>
> You can still view [Automation history](doc:logs)
