...
After publishing this automation, we can see the result by using Postman as an example:

![](https://files.readme.io/78d52b1-postman.png)
...
And now the result in Postman:

![](https://files.readme.io/b0987f7-Screenshot_2023-06-26_at_16.03.22.png)
