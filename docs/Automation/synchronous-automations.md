...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/884adf3cb82523c86649826b2781c0df4c1b4f68106324ff3469740e817271bd-Screenshot_2025-02-28_at_07.42.47.png",
        null,
        ""
      ],
      "align": "left",
...
> 
> [block:image]{"images":[{"image":["https://files.readme.io/e4b49db014e7999146714aae75b1d872130d20d79deff087e9692c434ba5b91e-Screenshot_2025-02-28_at_07.46.22.png",null,""],"align":"center"}]}[/block]
...
For example, consider this webhook automation that queries an Employees table, filtering on the _city_ value that is passed into the trigger:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c0d7a98a032694264ad104bae9314245712f8b62dabca41c597acd61fe1dbd0b-Screenshot_2025-02-28_at_07.53.29.png",
        null,
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/025b517c587158ec8f081e42a64c813f76dab0dd40d3b7652e8248a70efcf7cd-Screenshot_2025-02-28_at_07.59.19.png",
        null,
...
For users to access the result of your automations in a published Budibase app, you will need to configure an [App action](doc:app-action) trigger within the _Design_ section. Let's start off by creating a very simple automation that will get a specific row based on the \_id we are passing to it.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/94ee5c118656a97d93e44b350bae98b8246ef5e02ca8603e9fddfaa5c535625a-image.png",
        null,
        "Filter attached to the query rows step"
      ],
      "align": "center",
      "caption": "Filter attached to the query rows step"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2c25ca235df88584e338ab37662d36aac26367ed7d2d6fa65ffbb6d10743362f-image.png",
        null,
        ""
      ],
      "align": "center",
