...
next:
  description: ''
---
The **App users** table is a special <<glossary:Budibase DB>> table that stores all of the users that have access to the app. 

It is anchored to the top of the <<glossary:Datasource>> list, and has a unique icon to differentiate it from other tables: 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b988fc9-add_ds.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/400dbed96e783772fa7b06eeaac1c8c67c76c7c55ad590ee112c60c1e745f081-Screenshot_2024-09-09_at_09.49.28.png",
        "Screenshot 2022-05-04 at 15.15.00.png",
        "An image showing the users table, its columns and functions"
      ],
      "align": "center"
    }
  ]
...
It is possible to add auto-columns to your tables, which includes the _updated by_ column.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/363b3f1823ace137a8a1a9969eef0f31ea28fe33c65b0eee0ae6fc857e284d75-Screenshot_2024-09-09_at_10.09.54.png",
        "",
        "Adding a 'Updated By' auto-column"
      ],
      "align": "center",
      "caption": "Adding a 'Updated By' auto-column"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4e9cc1844b33432179804fa9995c7f932a586036dd748e2ba8a764cd24941c51-Screenshot_2024-09-09_at_10.10.07.png",
...
There are globally available <<glossary:Binding>>s for every column in the Users table, including the custom columns. 
...
Inside the container, add an [Icon](doc:icon), selecting _user-fill_ and set the _Size_ and _Color_. Then add a [Paragraph](https://docs.budibase.com/docs/displaying-text)  component with the text 'Create my profile'.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0369279855ae18bf2336324d13447d2b86d86fd0e86c398df2c18f5b8f17b9fe-Screenshot_2024-09-10_at_11.32.58.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f0d48126a382c6c3c5da9d44352edd8ef098bf171dc712bcda5f15168721403d-Screenshot_2024-09-10_at_11.36.54.png",
        "",
        ""
      ],
      "align": "center"
...
Add a [Side panel](doc:side-panel), and two nested [Form blocks](doc:form-block). Select the 'user details'  _Table_. Set the second form block _Type_ to 'Update'.

In the second form block, set the _Row ID_ to: `{{ User details data.Rows.0._id }}` and provide a _Title_.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/70924689c230ff67de3eca631bde4c1f0bd6cddab5134968269641f50f64377c-Screenshot_2024-09-10_at_11.40.53.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/66cc4a01a26d62956b7d86284fa3f77e8f244e1d330bbc38f5bd3e48d6773203-Screenshot_2024-09-10_at_11.43.28.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/07f9b81bbf9fd2abf6650a20b434d68cb8a838960e60b12174a46680412558b2-Screenshot_2024-09-10_at_11.44.53.png",
        "",
        ""
      ],
      "align": "center"
