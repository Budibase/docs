...
next:
  description: ''
---
Budibase DB is our native datasource. Any data you add here is stored directly on your Budibase instance and can be used by any apps or automations within your <<glossary:Workspace>>.
