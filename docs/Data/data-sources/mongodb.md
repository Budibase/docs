...
To connect your MongoDB <<glossary:Data Source>>, head over to the data section in the Budibase UI. Then, click the `+` icon in the left-hand settings panel to add a new data source.
