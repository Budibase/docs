...
To connect your MongoDB <Glossary>Data Source</Glossary>, head over to the data section in the Budibase UI. Then, click the `+` icon in the left-hand settings panel to add a new data source.

<Image title="add-data-source.png" alt={570} src="https://files.readme.io/91efe96-add-data-source.png">
...
<Image title="mongo-connectionstring.jpeg" alt={673} src="https://files.readme.io/7acce0f-mongo-connectionstring.jpeg">
