...
![](https://files.readme.io/c3e370a9ff9ed2ed9b14a69ada35d3b87f52a0a95fec342013d2491bddff74fb-image.png)
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f35e0d96e5dc2ae6f42d01f3275fd579ef602afec4d07a9bf1aeae9aff4bcc28-image.png",
        null,
        null
      ],
      "caption": "Fetch the checked tables from the list"
    }
  ]
}
[/block]
...
For the most part <<glossary:Binding>>s in PostgreSQL queries will behave much in the same way as other [Custom queries](https://docs.budibase.com/docs/data-sources#custom-queries) and as shown in the tutorial above.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bc29e2f-Screenshot_2024-02-29_at_10.52.05.png",
        "",
        "Query an interval of 'n' years"
      ],
      "align": "center",
      "caption": "Query an interval of 'n' years"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a594965-Screenshot_2024-02-29_at_10.57.51.png",
        "",
        "Text binding input must be cast to Postgres interval"
      ],
      "align": "center",
      "caption": "Text binding input must be cast to Postgres interval"
    }
  ]
}
[/block]