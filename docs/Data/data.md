...
By default, every Budibase application will start with a <<glossary:Budibase DB>> datasource. This database contains a [Users table](doc:users-table) which is considered a special table. This table includes all the users who have access to your application, with their respective roles.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ad4bf3e-Screenshot_2022-12-12_at_08.19.51.png",
        null,
        "Adding a datasource"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8d2e7b0-Screenshot_2023-06-27_at_12.06.35.png",
        null,
        "Choose a datasource"
      ],
      "align": "center",
