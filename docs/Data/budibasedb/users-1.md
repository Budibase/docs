...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9ad6a82-Screenshot_2023-10-30_at_14.53.21.png",
        "",
        "User column type"
      ],
      "align": "center",
      "sizing": "350px",
      "caption": "Adding a User column type"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a3e2801-user_col.png",
        "",
        "Searching for and adding a user"
      ],
      "align": "center",
      "caption": "Searching for and adding a user"
    }
  ]
}
[/block]
