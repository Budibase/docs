...
<Image alt="Note the slight variation in icons between Single User (team_leader) and Mutli User (team_members) columns" align="center" src="https://files.readme.io/8db9d38-image.png">
