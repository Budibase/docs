...
1. Create/select two tables that the relationship should be formed between. 
...
4. Here you will need to select two options, the tables to which this column relates, and the name of the relationship column in the other table as well.\
   ![Full example of relationship creation.](https://files.readme.io/8489817-small-Screenshot_2023-05-15_at_13.11.27.png)
...
### One-to-one (Not available in Budibase)

![](https://files.readme.io/4729d36-small-763ab24-one-to-one.png)

The one-to-one relationship **model isn't available** in Budibase. You will need to use a one-to-many relationship and carefully scope it so that it meets your needs.

This model is used whenever linking two rows together. A good example of this would be; a Teacher is assigned a single parking spot and that parking spot can only be used by a single teacher.
