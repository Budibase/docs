...
2. Make sure that in both tables there is a column defined that can be used for display purposes. When creating this column make sure to set it to the _Display column_.

   ![](https://files.readme.io/371deb5d67d5c2a750e9ae6a7e94267681066aba277ed09288a790d53d6c527f-image.png)
