...
Go to the [Upgrade](https://account.budibase.app/portal/upgrade) page and select the plan you wish to upgrade. Click on the upgrade button for the selected plan, a modal with instructions should popup. You can copy your license key from here
