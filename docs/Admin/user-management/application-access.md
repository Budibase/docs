...
> 📘 
> 
> By default, the first **50** app users with direct access will appear in the **Users** section, followed by all members of the **Groups**(🔒). 
> 
...
Any groups with access to your application will be displayed along with its total membership count. Updates to the group access level will be applied to all member users. Selecting the **Remove** option in the access dropdown will remove the group from the application and thereby revoke access of any members.
...
As you can see above, the user **s.donagy@email.com** was initially only granted **Basic** access to the application as a member of the **Press Team**. Now they have been upgraded to **Power** user.
