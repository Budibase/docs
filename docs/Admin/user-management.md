...
If you need to reset a users' password, you need to click the `Force password reset` button on the users\` detail page. You get displayed a new password for the user with which they can only log in once. Once logged in they will be prompted to change their password before continuing on.
