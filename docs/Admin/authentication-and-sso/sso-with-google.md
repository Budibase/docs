...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/19e0d6a-Screenshot_2022-09-05_at_15.43.38.png",
        null,
        ""
      ],
      "sizing": "200px",
...
Log in to your Budibase installation and visit the '**Auth**' section. Enter the Client ID and Client Secret generated above. The callback URL should be pre-filled based on the _Platform URL _ setting in the _Organisations_ menu. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c0bc205-image.png",
        null,
        ""
      ],
      "sizing": "400px"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a2311c9-image.png",
        null,
        ""
      ],
      "sizing": "300px",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/715d5ac-image.png",
        null,
        ""
      ],
      "sizing": "32px",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/073a5b3-image.png",
        null,
        ""
      ],
      "sizing": "260px",
